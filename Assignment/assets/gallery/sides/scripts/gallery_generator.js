...
$(document).ready(function() {
	...
	var send = "assets/gallery/sides/scripts/hook.php";
	...
	xmlHttp.onreadystatechange = function() {
		if(xmlHttp.readyState == 4) {
			...
			for (var i=0;i<response.length;i++) {
				...
				htmlCode += '<a href="assets/gallery/sides/images' + response[i] +' " ' + ' data-fancybox data-caption="My X3D model render" > ';
				htmlCode += '<img class="card-img-top gallery-thumbnail" src="assets/gallery/sides/images' + response[i] + '"/>';
				htmlCode += '</a>';			
