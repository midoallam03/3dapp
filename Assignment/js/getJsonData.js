...
$(document).ready(function(){
    ...
    $.getJSON('assets/fonts/data.json', function(jsonObj) {
       console.log(jsonObj);
       ...
       $('#x3dCreationMethod_oasis').html('<p>' + jsonObj.pageTextData[6].x3dCreationMethod + '<p>');
        $('#title_oasis').html('<h2>' + jsonObj.pageTextData[6].title + '<h2>');
       $('#subTitle_oasis').html('<h3>' + jsonObj.pageTextData[6].subTitle + '</h3>');
       $('#description_oasis').html('<p>' + jsonObj.pageTextData[6].description + '</p>');
...
$(document).ready(function(){
    ...
    $("#btnCoke").click(function(){
        $("#description_left").fadeOut(); 
    });
    $("#btnCoke2").click(function(){
        $("#description_left").fadeIn();
    });

    $("#btnFanta").click(function(){
        $("#description_centre").fadeOut();
    });
    $("#btnFanta2").click(function(){
        $("#description_centre").fadeIn();
    });

    $("#btnOasis").click(function(){
        $("#description_right").fadeOut();
    });
    $("#btnOasis2").click(function(){
        $("#description_right").fadeIn();
    });
});
